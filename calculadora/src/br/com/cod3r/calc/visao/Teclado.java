...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		setLayout(layout);//GridLayout -> botões do mesmo tamanho!
		c.fill = GridBagConstraints.BOTH; //Preenche o botão nas duas direções!
		c.weightx = 1;//Peso relacionado ao eixo X, ocupar o eixo X completamente ou não! 
		c.weighty = 1;
//		GridBagLayout = mais flexível// gridy = linha , gridx= coluna
//		LINHA 1
...
//		LINHA 5
	...
	@Override
	public void actionPerformed(ActionEvent e) { //Ação foi executada
		if(e.getSource()instanceof JButton) { //conferindo se foi um botão que sofreu o evento
			JButton botao = (JButton) e.getSource(); //pegando qual botão sofreu o evento			
//			System.out.println(botao.getText());//pegando o texto do botão
